...
if( !class_exists( 'WeFix_Shop_Others_Recently_Viewed_Products_Include' ) ) {

    class WeFix_Shop_Others_Recently_Viewed_Products_Include {
        ...
        function __construct() {
			...
			add_action( 'wefix_hook_bottom', array( $this, 'wefix_shop_recently_viewed_products_content' ) );
			add_action( 'wp', array( $this, 'wefix_shop_set_recently_viewed_products' ) );
         ...
         */
			function wefix_shop_recently_viewed_products_content() {
							...
							echo '<div class="wdt-shop-recently-viewed-products-holder">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
									...
									echo '<div class="wdt-shop-recently-viewed-products-title">';
										echo esc_html__('Recently Viewed', 'wefix-pro');
									echo '</div>';
												...
												echo '<div class="wdt-shop-recently-viewed-product swiper-slide">';
													...
													echo '<div class="wdt-shop-recently-viewed-product-info">';
														...
														if( !empty($add_to_cart) ) {
															...
															echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'wefix-pro' ).'">'.wefix_html_output($add_to_cart).'</div>';
						...
						echo '<div class="wdt-shop-recently-viewed-products-holder">';
							...
							echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-container">';
									echo esc_html__('Sorry, there are no products.', 'wefix-pro');
								echo '</div>';
         ...
         */
			function wefix_shop_set_recently_viewed_products() {
				if(is_product()) {
...
if( !function_exists('wefix_shop_others_recently_viewed_products_include') ) {
	function wefix_shop_others_recently_viewed_products_include() {
        $reflection = new ReflectionClass('WeFix_Shop_Others_Recently_Viewed_Products_Include');
        return $reflection->newInstanceWithoutConstructor();
	}
}

WeFix_Shop_Others_Recently_Viewed_Products_Include::instance();