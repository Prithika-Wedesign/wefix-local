...
if( !class_exists( 'WeFix_Shop_Others_Search' ) ) {

    class WeFix_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'wefix-pro')
                    )
                );
...
if( !function_exists('wefix_shop_others_search') ) {
	function wefix_shop_others_search() {
        $reflection = new ReflectionClass('WeFix_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

WeFix_Shop_Others_Search::instance();