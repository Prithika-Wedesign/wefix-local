...
if( !class_exists( 'WeFix_Shop_Others_Cart' ) ) {

    class WeFix_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('wefix_shop_others_cart') ) {
	function wefix_shop_others_cart() {
        $reflection = new ReflectionClass('WeFix_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

WeFix_Shop_Others_Cart::instance();