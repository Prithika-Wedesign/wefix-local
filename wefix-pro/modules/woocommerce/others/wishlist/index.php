...
if( !class_exists( 'WeFix_Shop_Others_Wishlist' ) ) {

    class WeFix_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('wefix_shop_others_wishlist') ) {
	function wefix_shop_others_wishlist() {
        $reflection = new ReflectionClass('WeFix_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

WeFix_Shop_Others_Wishlist::instance();