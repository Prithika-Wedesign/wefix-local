...
if( !class_exists( 'WeFix_Woo_Listing_Customizer_Settings' ) ) {

    class WeFix_Woo_Listing_Customizer_Settings {
            ...
            function register( $wp_customize ) {
                ...
                $wp_customize->add_panel(
                    new WeFix_Customize_Panel(
                        ...
                        array(
                            'title'    => esc_html__('WeFix - WooCommerce', 'wefix-pro'),
                            'priority' => wefix_customizer_panel_priority( 'woocommerce' )
                        )
                    )
                );
...
if( !function_exists('wefix_woo_listing_customizer_settings') ) {
	function wefix_woo_listing_customizer_settings() {
		return WeFix_Woo_Listing_Customizer_Settings::instance();
	}
}

wefix_woo_listing_customizer_settings();
