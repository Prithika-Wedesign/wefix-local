...
if( !class_exists( 'WeFix_Shop_Single_Module_Buy_Now' ) ) {

    class WeFix_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('wefix_shop_single_module_buy_now') ) {
	function wefix_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('WeFix_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'WeFix_Shop_Single_Module_Custom_template' ) ) {
    WeFix_Shop_Single_Module_Buy_Now::instance();
}