...
if (!class_exists('WeFix_Shop_Metabox_Single_CT')) {
	class WeFix_Shop_Metabox_Single_CT
	{
		...
		function wefix_shop_product_custom_settings($options)
		{
			...
			$product_options = array(
				...
				array(
					'id'      => 'product-template',
					'type'    => 'select',
					'title'   => esc_html__('Product Template', 'wefix-pro'),
					'class'   => 'chosen',
					'options' => array(
						'admin-option'    => esc_html__('Admin Option', 'wefix-pro'),
						'woo-default'     => esc_html__('WooCommerce Default', 'wefix-pro'),
						'admin-template' => esc_html__('Same Template for all Products', 'wefix-pro'),
					...
					'info' => esc_html__('Don\'t use product shortcodes in content area when "WooCommerce Default" template is chosen.
						...
						"Admin template" will use the same template for all products.', 'wefix-pro'),
				...
				array(
					...
					'info'       => esc_html__('Choose "Elementor Templates" here to use for "Description", if you choose "Custom Description" option you can provide your own content below. This content will be used when "Custom Template" is chosen in "Product Template" option.', 'wefix-pro'),
...
WeFix_Shop_Metabox_Single_CT::instance();
