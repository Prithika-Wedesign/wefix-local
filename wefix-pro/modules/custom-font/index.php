...
if( !class_exists( 'WeFixProCustomFont' ) ) {
    class WeFixProCustomFont {
        ...
        function load_modules() {
            include_once WEFIX_PRO_DIR_PATH.'modules/custom-font/taxonomy/index.php';
        }

        function load_customizer(){
            add_filter( 'wefix_customizer_custom_fonts', array( $this, 'fonts_list' ), 20 );
        }
        ...
        function elementor_group( $font_groups ) {
            ...
            if( count( $fonts ) > 0 ) {
                $new_group[ 'wefix_custom_fonts' ] = esc_html__( 'Custom Font', 'wefix-pro' );
        ...
        function load_frontend() {
            add_filter( 'wefix_add_inline_style', array( $this, 'custom_font_style' ) );
        }
        ...
        function get_fonts() {
            ...
            $fonts = array();
            $terms = get_terms( 'wefix_custom_fonts', array( 'hide_empty' => false ) );
        ...
        function get_font_links( $id ) {
            $meta = get_term_meta( $id, '_wefix_custom_font_options', true );
