...
class Elementor_Post_Author extends WeFixElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author', 'wefix-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-wrapper '.$style.' '.$el_class.'">';
            $out .= wefix_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author', '', $template_args );
		$out .= '</div>';
