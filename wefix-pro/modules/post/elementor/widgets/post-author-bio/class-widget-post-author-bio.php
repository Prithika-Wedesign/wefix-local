...
class Elementor_Post_Author_Bio extends WeFixElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author Bio', 'wefix-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-bio-wrapper '.$el_class.'">';
            $out .= wefix_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author_bio', '', $template_args );
		$out .= '</div>';
