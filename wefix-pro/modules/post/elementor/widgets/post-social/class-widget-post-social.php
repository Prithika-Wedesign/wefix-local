...
class Elementor_Post_Socials extends WeFixElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Socials', 'wefix-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-social-share-wrapper '.$style.' '.$el_class.'">';
			$out .= wefix_get_template_part( 'post', 'templates/post-extra/social', '', $template_args );
		$out .= '</div>';
