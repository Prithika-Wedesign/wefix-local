...
if( ! function_exists( 'cs_framework_init' ) && ! class_exists( 'CSFramework' ) ) {
  function cs_framework_init() {
    ...
    defined( 'CS_ACTIVE_OPTIONS' )     or  define( 'CS_ACTIVE_OPTIONS',     true );
    ...
    // cs_locate_template( 'classes/options.options.php'  );
    cs_locate_template( 'classes/options-page.class.php' );
