(function ($) {
    ...
    const wdtWidgetsAnimationEffectHandlerInit = function($scope) {
		...
		$self.animationEffectMouseMove = function() {
			...
			// Wrap with div to apply mouse move effect
				...
				$scope.wrapInner('<div class="wdt-effect-mouse-move-wrapper layer" />')
		...
		$self.animationEffectAutoMovement = function() {
			...
			// Wrap with auto movement div
				$scope.wrapInner('<div class="wdt-effect-auto-movement-wrapper" />')
	...
	const wdtWidgetsDarkModeHandlerInit = function($scope) {
		...
		$self.darkModeInit = function() {
			...
			// if($editMode) {
			// 	$darkModeSettings = $self.generateEditorSettings($widgetId);
			// } else {
