			...
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'styles' => array (
					'alignment' => array (
                        ...
                        'default' => 'center',
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-wrapper,
							 {{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder .wdt-accordion-toggle-title' => 'text-align: {{VALUE}}; justify-content: {{VALUE}};'
						),
						'condition' => array ()
					),
					'padding' => array (
						'field_type' => 'padding',
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'background' => array (
						'field_type' => 'background',
						'selector' => '{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-wrapper',
						'condition' => array ()
					),
					'border' => array (
						'field_type' => 'border',
					...
					'border_radius' => array (
						...
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'box_shadow' => array (
			...
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'styles' => array (
						...
						'tab_items' => array (
							'normal' => array (
								...
								'styles' => array (
									...
									'color_background' => array (
										...
										'selector' => array (
											'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder' => 'background-color: {{VALUE}};'
										),
										'condition' => array ()
									)
								)
							...
							'active' => array (
								...
								'styles' => array (
									'border' => array (
										'field_type' => 'border',
										'selector' => '{{WRAPPER}} .wdt-accordion-toggle-wrapper .wdt-accordion-toggle-title-holder.ui-state-active, 
													   {{WRAPPER}} .wdt-accordion-toggle-wrapper .wdt-accordion-toggle-title-holder.ui-state-hover',
										'condition' => array ()
									),
									'border_radius' => array (
										'field_type' => 'border_radius',
										'selector' => array (
											'{{WRAPPER}} .wdt-accordion-toggle-wrapper .wdt-accordion-toggle-title-holder.ui-state-active, 
											 {{WRAPPER}} .wdt-accordion-toggle-wrapper .wdt-accordion-toggle-title-holder.ui-state-hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
										),
										'condition' => array ()
									),
									'color_title' => array (
										...
										'label' => esc_html__( 'Color', 'wdt-elementor-addon' ),
										'selector' => array (
											'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-active .wdt-accordion-toggle-title, 
											 {{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-hover .wdt-accordion-toggle-title' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'color_icon' => array (
										...
										'label' => esc_html__( 'Icon Color', 'wdt-elementor-addon' ),
										'selector' => array (
											'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-active .wdt-accordion-toggle-icon, 
											 {{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-hover .wdt-accordion-toggle-icon' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'color_background' => array (
										...
										'label' => esc_html__( 'Background Color', 'wdt-elementor-addon' ),
										'selector' => array (
											'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-active, 
											 {{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-title-holder.ui-state-hover' => 'background-color: {{VALUE}};'
										),
										'condition' => array ()
									)
								)
					...
					'color_content_text' => array (
						...
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-description.ui-accordion-content-active, 
							 {{WRAPPER}} .wdt-accordion-toggle-holder .wdt-accordion-toggle-description.ui-accordion-content-active p' => 'color: {{VALUE}};'
						),
						'condition' => array ()
					)
				)
