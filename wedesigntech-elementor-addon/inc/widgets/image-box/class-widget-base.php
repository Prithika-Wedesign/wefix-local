	...
	function __construct() {
		...
		// Options
			...
			$options['default'] = array(
				...
				'title_description' => esc_html__( 'Title & Description', 'wdt-elementor-addon'),
			);
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'feature-template' => esc_html__( 'Feature Template', 'wdt-elementor-addon' ),
					'contact-template' => esc_html__( 'Contact Template', 'wdt-elementor-addon' ),
					'service-template' => esc_html__( 'Service Template', 'wdt-elementor-addon' ),
					'award-template' => esc_html__( 'Award Template', 'wdt-elementor-addon' ),
					'brand-template' => esc_html__( 'Brand Logos', 'wdt-elementor-addon' ),
					'client-template' => esc_html__( 'Client Logos', 'wdt-elementor-addon' ),
					'support-template' => esc_html__( 'Support Template', 'wdt-elementor-addon' ),
					'service-detail-template' => esc_html__( 'Service detail Template', 'wdt-elementor-addon' ),
				)
			) );
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= $this->cc_layout->get_wrapper_start();
				if($settings['template'] == 'default') {
					...
					$output .= $this->cc_repeater_contents->render_html($widget_object, $settings);
				} else if($settings['template'] == 'feature-template'){
				...
				} else if($settings['template'] == 'contact-template'){
				...
				} else if($settings['template'] == 'service-template'){
				...
				} else if($settings['template'] == 'award-template'){
				...
				} else if($settings['template'] == 'brand-template'){
				...
				} else if($settings['template'] == 'client-template'){
				...
				} else if($settings['template'] == 'support-template'){
				...
				} else if($settings['template'] == 'service-detail-template'){
