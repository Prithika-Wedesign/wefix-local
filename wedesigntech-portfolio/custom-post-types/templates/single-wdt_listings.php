	...
	?>
		...
		*/
		...
		<div class="entry-post-navigation">
			...
			if ( $prev_post ) {
				echo '<div class="wdt-nav-previous"><a href="' . get_permalink( $prev_post->ID ) . '">' . esc_html__( "previous project", "wdt-portfolio" ) . '</a></div>';
			} else {
				echo '<div class="wdt-nav-previous disabled">No previous project available</div>';
			}

			if ( $next_post ) {
				echo '<div class="wdt-nav-next"><a href="' . get_permalink( $next_post->ID ) . '">' . esc_html__( "next project", "wdt-portfolio" ) . '</a></div>';
			} else {
				echo '<div class="wdt-nav-next disabled">No next project available</div>';
			}
			?>
