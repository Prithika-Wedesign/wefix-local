...
class WeFix_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'wefix-plus-spacing-control', WEFIX_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-spacing-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, WEFIX_PLUS_VERSION );
	}
