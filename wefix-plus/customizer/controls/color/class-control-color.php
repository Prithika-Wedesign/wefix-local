...
class WeFix_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'wefix-plus-color-control', WEFIX_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'wefix-plus-customizer-color-picker' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-color-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/color/color.css', null, WEFIX_PLUS_VERSION );
	}
