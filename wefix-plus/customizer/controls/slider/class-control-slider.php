...
class WeFix_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wefix-plus-slider-control', WEFIX_PLUS_DIR_URL.'customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-slider-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/slider/slider.css', null, WEFIX_PLUS_VERSION );
	}
