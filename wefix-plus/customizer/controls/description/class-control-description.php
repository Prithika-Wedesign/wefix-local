...
class WeFix_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'wefix-plus-description-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/description/description.css', null, WEFIX_PLUS_VERSION );
	}
