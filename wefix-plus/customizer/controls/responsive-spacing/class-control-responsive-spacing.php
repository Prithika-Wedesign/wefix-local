...
class WeFix_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'wefix-plus-responsive-spacing-control', WEFIX_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-responsive-spacing-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, WEFIX_PLUS_VERSION );
	}
