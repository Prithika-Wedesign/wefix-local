...
class WeFix_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wefix-plus-radio-image-control', WEFIX_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-radio-image-control',  WEFIX_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, WEFIX_PLUS_VERSION );
	}
