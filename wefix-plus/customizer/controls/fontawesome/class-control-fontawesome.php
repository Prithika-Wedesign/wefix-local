...
class WeFix_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'wefix-plus-fontawesome-control', WEFIX_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-fontawesome-control',  WEFIX_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, WEFIX_PLUS_VERSION );

		wp_enqueue_style( 'wefix-plus-fontawesome',  WEFIX_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),WEFIX_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "wefix-plus") .' '.esc_html( $this->label );
