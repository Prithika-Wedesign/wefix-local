...
class WeFix_Customize_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'wefix-plus-switch-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/switch/switch.css', null, WEFIX_PLUS_VERSION );
		wp_enqueue_script( 'wefix-plus-switch-control', WEFIX_PLUS_DIR_URL.'customizer/controls/switch/switch.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
	}
			...
			<div class="customize-control-content switch">
				...
				<label class="switch-label" for="switch_{{ data.id }}">
					<span class="switch-on">
						<# data.choices.on = data.choices.on || '<?php esc_html_e( 'On', 'wefix-plus' ); ?>' #>
						{{ data.choices.on }}
					</span>
					<span class="switch-off">
						<# data.choices.off = data.choices.off || '<?php esc_html_e( 'Off', 'wefix-plus' ); ?>' #>
						{{ data.choices.off }}
					</span>
				</label>
			</div>
