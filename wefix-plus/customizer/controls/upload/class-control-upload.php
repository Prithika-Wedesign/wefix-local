...
class WeFix_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'wefix-plus-upload-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/upload/upload.css', null, WEFIX_PLUS_VERSION );
		wp_enqueue_script( 'wefix-plus-upload-control', WEFIX_PLUS_DIR_URL.'customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'wefix-plus' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
