...
class WeFix_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wefix-plus-responsive-slider-control', WEFIX_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-responsive-slider-control',  WEFIX_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, WEFIX_PLUS_VERSION );
	}
