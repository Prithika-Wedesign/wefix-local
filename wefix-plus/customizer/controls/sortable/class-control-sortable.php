...
class WeFix_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wefix-plus-sortable-control', WEFIX_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-sortable-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, WEFIX_PLUS_VERSION );
	}
