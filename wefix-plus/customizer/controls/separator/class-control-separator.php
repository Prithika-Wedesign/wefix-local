...
class WeFix_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'wefix-plus-separator-control',  WEFIX_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, WEFIX_PLUS_VERSION );
	}
