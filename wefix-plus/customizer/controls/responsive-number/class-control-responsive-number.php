...
class WeFix_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'wefix-plus-responsive-number-control', WEFIX_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), WEFIX_PLUS_VERSION, true );
		wp_enqueue_style( 'wefix-plus-responsive-number-control',  WEFIX_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, WEFIX_PLUS_VERSION );
	}
