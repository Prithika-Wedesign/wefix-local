;(function ( $, window, document, undefined ) {
    'use strict';
    $.WEFIXPLUSWPCUSTOMIZER = $.WEFIXPLUSWPCUSTOMIZER || {};

	$.WEFIXPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.WEFIXPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.WEFIXPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').WEFIXPLUSWPCUSTOMIZER_DEPENDENCY();
	});
