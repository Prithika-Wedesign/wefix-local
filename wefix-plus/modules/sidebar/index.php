...
if( !class_exists( 'WeFixPlusSidebar' ) ) {
    class WeFixPlusSidebar {
        ...
        function load_modules() {
            include_once WEFIX_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('wefix_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('wefix_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
