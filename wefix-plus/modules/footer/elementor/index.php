...
if( !class_exists( 'WeFixPlusFooterElementor' ) ) {
    class WeFixPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'wefix_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
            ...
            return apply_filters( 'wefix_plus_footer_content', $content );
		}
    }
}

WeFixPlusFooterElementor::instance();