...
if( !class_exists( 'WeFixPlusBreadCrumbColor' ) ) {
    class WeFixPlusBreadCrumbColor {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new WeFix_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Colors & Background', 'wefix-plus'),
            ...
            if ( ! defined( 'WEFIX_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new WeFix_Customize_Control_Separator(
                        $wp_customize, WEFIX_CUSTOMISER_VAL . '[wefix-plus-site-breadcrumb-color-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
WeFixPlusBreadCrumbColor::instance();