...
if( !class_exists( 'WeFixPlusHeaderIconsWidget' ) ) {
    class WeFixPlusHeaderIconsWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require WEFIX_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/header-icons/class-widget-header-icons.php';
            $widgets_manager->register( new \Elementor_Header_Icons() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-header-icons',
                WEFIX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-icons.css', array(), WEFIX_PLUS_VERSION );

            if( function_exists( 'is_woocommerce' ) ) {
                wp_register_style( 'wdt-header-carticons',
                    WEFIX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-carticon.css', array(), WEFIX_PLUS_VERSION );
            }
        }

        function register_widget_scripts() {
            wp_register_script( 'jquery-nicescroll',
                WEFIX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/jquery.nicescroll.js', array(), WEFIX_PLUS_VERSION, true );
            wp_register_script( 'wdt-header-icons',
                WEFIX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/header-icons.js', array(), WEFIX_PLUS_VERSION, true );
        }
...
WeFixPlusHeaderIconsWidget::instance();
