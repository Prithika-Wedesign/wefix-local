...
if( !class_exists( 'WeFixPlusLogoWidget' ) ) {
    class WeFixPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require WEFIX_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                WEFIX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), WEFIX_PLUS_VERSION );
        }
