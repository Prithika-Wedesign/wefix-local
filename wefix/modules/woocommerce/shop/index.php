...
if( !class_exists( 'WeFix_Woo_Listing_Shop' ) ) {

    class WeFix_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'wefix_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('wefix_woo_listing_shop') ) {
	function wefix_woo_listing_shop() {
		return WeFix_Woo_Listing_Shop::instance();
	}
}

wefix_woo_listing_shop();