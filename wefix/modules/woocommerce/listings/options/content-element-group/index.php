...
if( !class_exists( 'WeFix_Woo_Listing_Option_Content_Element_Group' ) ) {

    class WeFix_Woo_Listing_Option_Content_Element_Group extends WeFix_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'wefix_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('wefix_woo_listing_option_content_element_group') ) {
	function wefix_woo_listing_option_content_element_group() {
		return WeFix_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

wefix_woo_listing_option_content_element_group();