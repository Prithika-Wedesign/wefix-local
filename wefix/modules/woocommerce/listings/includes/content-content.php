...
if( ! function_exists( 'wefix_shop_woo_loop_product_content' ) ) {

	function wefix_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				wefix_shop_woo_loop_product_content_content_setup($product_content_content);

				echo '<div class="product-details">';
					// Product Offer Percentage
					if($product_show_offer_percentage) {
						global $product;
						echo wefix_shop_woo_loop_product_offer_percentage($product);
					}
					// Others
					do_action('wefix_woo_loop_product_content_content', 'content');
					remove_all_actions('wefix_woo_loop_product_content_content');
	...
	add_action( 'woocommerce_shop_loop_item_title', 'wefix_shop_woo_loop_product_content', 10 );
