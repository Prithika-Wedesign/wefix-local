...
if( !class_exists( 'WeFix_Shop_Single_Module_Upsell_Related' ) ) {

    class WeFix_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( wefix_is_file_in_theme( __FILE__ ) ) {
                    return WEFIX_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'wefix_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('wefix_shop_single_module_upsell_related') ) {
	function wefix_shop_single_module_upsell_related() {
		return WeFix_Shop_Single_Module_Upsell_Related::instance();
	}
}

wefix_shop_single_module_upsell_related();