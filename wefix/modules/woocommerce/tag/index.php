...
if( !class_exists( 'WeFix_Woo_Listing_Tag' ) ) {

    class WeFix_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'wefix_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('wefix_woo_listing_tag') ) {
	function wefix_woo_listing_tag() {
		return WeFix_Woo_Listing_Tag::instance();
	}
}

wefix_woo_listing_tag();